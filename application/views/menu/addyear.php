    ...
    <!-- Main content -->
     ...
     <form id="yearform"> 
        ...
        <div class="box-body">
          ...
          <div class="col-xs-5">
              <input id="year" name="year" class="form-control" type="text" placeholder="Enter Year">         
         </div>
          <div class="col-xs-2">
          <button type="button" class="btn btn-block btn-primary add_year">Add</button>
          </div>
        </div>
        <!-- /.box-body -->
...
<form name="updateyearform" id="updateyearform">
  <!-- /.content-wrapper -->
      ...
      <div class="modal-body">
        <p>
          <div class="form-group has-feedback">
            <label>Year</label>
        <input type="text" name="yr" id="yr" class="form-control"  required="required" autofocus="autofocus">
        </div>
        <div class="form-group has-feedback">
         <!-- <label>id</label> -->
...
<script>
  $(document).ready(function() {
   $('.add_year').click(function(){
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url(); ?>/data/addyear",
 ...
 "ajax": {
     "url": "<?php echo site_url("tdata/getyeardata")?>",
     "type": "GET"
 },
...
//                       $(".update_btn").show();
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/getmodelyear",
             dataType : "json",
             data: {"year_id" : year_id},
             success: function(response){

                   console.log(response);
                   $('#yr').val(response[0].year);
                   $('#id').val(response[0].year_id);
                   $('#id').hide();
...
$('.update_btn').click(function(){
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/yearupdate",
