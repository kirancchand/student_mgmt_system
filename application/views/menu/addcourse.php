    ...
    <!-- Main content -->
     ...
     <form id="courseform"> 
        ...
        <div class="box-body">
          ...
          <div class="col-xs-2">
          <button type="button" class="btn btn-block btn-primary add_course">Add</button>
          </div>
        </div>
        <!-- /.box-body -->
...
<form name="updatecourseform" id="updatecourseform">
  <!-- /.content-wrapper -->
...
<script>
  $(document).ready(function() {
   $('.add_course').click(function(){
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url(); ?>/data/addcourse",
 ...
 "ajax": {
     "url": "<?php echo site_url("tdata/getcoursedata")?>",
     "type": "GET"
 },
...
//                       $(".update_btn").show();
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/getmodelcourse",
             dataType : "json",
...
//                       $(".update_btn").show();
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/coursedelete",
             dataType : "json",
             data: {"course_id" : course_id},
             success: function(response){
...
$('.update_btn').click(function(){
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/courseupdate",
