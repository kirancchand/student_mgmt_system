  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
     ...
     <form id="usertypeform"> 
        ...
        <div class="box-body">
          <div class="col-xs-5">
              <input type="text" id="usertype" name="usertype" class="form-control" placeholder="Enter usertype">
                    
          </div>
          <div class="col-xs-2">
          <button type="button" class="btn btn-block btn-primary addusertype">Add</button>
          </div>
        </div>
        <!-- /.box-body -->
...
<form name="updateusertypeform" id="updateusertypeform">
  <!-- /.content-wrapper -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" name="utype" id="utype" class="form-control"  required="required" autofocus="autofocus">
        </div>
        <div class="form-group has-feedback">
         <!-- <label>id</label> -->
...
<script>
  $(document).ready(function() {
   $('.addusertype').click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url(); ?>/data/addusertype",
 ...
 "ajax": {
     "url": "<?php echo site_url("tdata/getusertypedata")?>",
     "type": "GET"
 },
...
//                       $(".update_btn").show();
                   var utype_id=$(this).attr('id'); 
         
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/getmodelusertype",
             dataType : "json",
             data: {"utype_id" : utype_id},
             success: function(response){

                   console.log(response);
                   $('#utype').val(response[0].usertype);
                   $('#id').val(response[0].utype_id);
                   $('#id').hide();
...
$('.update_btn').click(function(){
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/usertypeupdate",
             data: $('#updateusertypeform').serialize(),
             dataType: "json",
             success: function(response){
             // alert(response);  
