    ...
    <!-- Main content -->
     ...
     <form id="dayform"> 
        ...
        <div class="box-body">
          ...
          <div class="col-xs-5">
              <input type="day_name" id="day_name" name="day_name" class="form-control" type="text" placeholder="Enter sub">         
         </div>
          <div class="col-xs-2">
          <button type="button" class="btn btn-block btn-primary add_day">Add</button>
          </div>
        </div>
        <!-- /.box-body -->
...
<form name="updatedayform" id="updatedayform">
  <!-- /.content-wrapper -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Update Day</h4>
      </div>
      <div class="modal-body">
        <p>
          <div class="form-group has-feedback">
            <label>Day Name</label>
        <input type="text" name="dayname" id="dayname" class="form-control"  required="required" autofocus="autofocus">
        </div>
        <div class="form-group has-feedback">
         <!-- <label>id</label> -->
...
<script>
  $(document).ready(function() {
   $('.add_day').click(function(){
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url(); ?>/data/addday",
 ...
 "ajax": {
     "url": "<?php echo site_url("tdata/getdaydata")?>",
     "type": "GET"
 },
...
//                       $(".update_btn").show();
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/getmodelday",
             dataType : "json",
             data: {"day_id" : day_id},
             success: function(response){

                   console.log(response);
                   $('#dayname').val(response[0].day_name);
                   $('#id').val(response[0].day_id);
                   $('#id').hide();
...
$('.update_btn').click(function(){
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/dayupdate",
             data: $('#updatedayform').serialize(),
             dataType: "json",
             success: function(response){
             // alert(response);  
