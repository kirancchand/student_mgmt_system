    ...
    <!-- Main content -->
     ...
     <form id="periodform"> 
        ...
        <div class="box-body">
          ...
          <div class="col-xs-5">
              <input type="text" id="period_name" name="period_name" class="form-control" type="text" placeholder="Enter Period Name">         
         </div>
         <div class="col-xs-5">
              <input type="text" id="period_time" name="period_time" class="form-control" type="text" placeholder="Enter Period Time">         
         </div>
          <div class="col-xs-2">
          <button type="button" class="btn btn-block btn-primary add_period">Add</button>
          </div>
        </div>
        <!-- /.box-body -->
...
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">PeriodList</h3>
...
<form name="updateperiodform" id="updateperiodform">
  <!-- /.content-wrapper -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Update Period</h4>
      </div>
      <div class="modal-body">
        <p>
          <div class="form-group has-feedback">
            <label>Period Name</label>
        <input type="text" name="periodname" id="periodname" class="form-control"  required="required" autofocus="autofocus">
        </div>
        <div class="form-group has-feedback">
            <label>Period Time</label>
        <input type="text" name="periodtime" id="periodtime" class="form-control"  required="required" autofocus="autofocus">
        </div>
        <div class="form-group has-feedback">
         <!-- <label>id</label> -->
...
<script>
  $(document).ready(function() {
   $('.add_period').click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url(); ?>/data/addperiod",
 ...
 "ajax": {
     "url": "<?php echo site_url("tdata/getperioddata")?>",
     "type": "GET"
 },
...
//                       $(".update_btn").show();
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/getmodelperiod",
             dataType : "json",
             data: {"period_id" : period_id},
             success: function(response){

                   console.log(response);
                   $('#periodname').val(response[0].period_name);
                   $('#periodtime').val(response[0].period_time);
                   $('#id').val(response[0].period_id);
                   $('#id').hide();
...
$('.update_btn').click(function(){
         ...
         $.ajax({
             type: "POST",
             url: "<?php echo site_url(); ?>/mdata/periodupdate",
