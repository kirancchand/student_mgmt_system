     ...
     <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Add all subjects</h3>

     <form method="post" action="<?php echo site_url('menu/addallsub'); ?>"> 
        ...
        <div class="box-body">
          ...
          <div class="col-xs-5">
              <input type="subname" id="subname" name="subname" class="form-control" type="text" placeholder="Enter subject">         
         </div>
          <div class="col-xs-2">
